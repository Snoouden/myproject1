                                 ...
                                 <div id="myCarousel" class="carousel slide" data-ride="carousel"><!-- carousel slide Begin -->
                                     <ol class="carousel-indicators"><!-- carousel-indicators Begin -->
                                        ...
                                        <div class="carousel-inner">
                                            ...
                                            <div class="item">
                                                <center><img class="img-responsive" src="admin_area/product_images/<?php echo $pro_img2; ?>" alt="Product 3-a"></center>
                                            </div>
                                            <div class="item">
                                                 <center><img class="img-responsive" src="admin_area/product_images/<?php echo $pro_img3; ?>" alt="Product 3-a"></center>
                                            </div>
                                        </div>
                             ...
                             <div class="col-sm-6"><!-- col-sm-6 Begin -->
                                 ...
                                 <?php add_cart(); ?>  
                                    ...
                                    <form action="details.php?add_cart=<?php echo $product_id; ?>" class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                                        ...
                                        <div class="form-group"><!-- form-group Begin -->
                                           <label for="" class="col-md-5 control-label">Products Memory</label>
                                            ...
                                            <div class="col-md-7"><!-- col-sm-7 Begin -->
                                                <select name="product_memory" id="" class="form-control "required oninput="setCustomValidity('')" oninvalid="setCustomValidity('Must pick 1 storage for the product')"><!-- select Begin -->

                                                    <option disabled selected>Select a Memory</option>
                                                    <option>8gb</option>
                                                    <option>16gb</option>
                                                    <option>32gb</option>
                                                    <option>64gb</option>
                                        ...
                                        <div class="form-group" ><!--  form-group Begin -->
                                            <label class="col-md-5 control-label">Products Storage</label>

                                             <div class="col-md-7"><!--  col-md-7 Begin -->

                                             <select name="product_storage" class="form-control "required oninput="setCustomValidity('')" oninvalid="setCustomValidity('Must pick 1 storage for the product')"><!--  form-control Begin -->
                                                    <option disabled selected>Select a Storage</option>
                                                    <option>256gb</option>
                                                    <option>512gb</option>
                                                    <option>1tb</option>
                                ...
                                <div class="row" id="thumbs"><!-- row Begin -->
                                        ...
                                        <div class="col-xs-4"><!-- col-xs-4 Begin -->
                                          <a data-target="#myCarousel" data-slide-to="0" href="#" class="thumb"><!-- thumb Begin -->
                                              <img src="admin_area/product_images/<?php echo $pro_img1; ?>" alt="Laptop1" class="img-responsive">
                                            </a><!-- thumb Finish -->
                                        </div><!-- col-xs-4Finish -->
                                        <div class="col-xs-4"><!-- col-xs-4 Begin -->
                                          <a data-target="#myCarousel" data-slide-to="1" href="#" class="thumb"><!-- thumb Begin -->
                                              <img src="admin_area/product_images/<?php echo $pro_img2; ?>" alt="Laptop2" class="img-responsive">
                                            </a><!-- thumb Finish -->
                                        </div><!-- col-xs-4Finish -->
                                        <div class="col-xs-4"><!-- col-xs-4 Begin -->
                                          <a data-target="#myCarousel" data-slide-to="2" href="#" class="thumb"><!-- thumb Begin -->
                                              <img src="admin_area/product_images/<?php echo $pro_img3; ?>" alt="laptop3" class="img-responsive">
                                            </a><!-- thumb Finish -->
                                        </div><!-- col-xs-4Finish -->
