                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="product_url" type="text" class="form-control" required value="<?php echo $p_url; ?>">
                            ...
                            <p style="font-weight:bold;font-style:italic;font-size:16px;"> Use Dash '-' for url. | Example: Macbook Pro M1 </p>
...
if(isset($_POST['update'])){
    ...
    if(is_uploaded_file($_FILES['file']['tmp_name'])){
        ...
        $update_product = "update products set p_cat_id='$product_cat',cat_id='$cat',manufacturer_id='$manufacturer_id',date=NOW(),product_title='$product_title',product_url='$product_url',product_keywords='$product_keywords',product_desc='$product_desc',product_price='$product_price' where product_id='$p_id'";
